...
class TarCommMAC:
    def __init__(self, scheme, groups, args):
        ...
        if args.comm:
            self.comm = comm_REGISTRY[self.args.comm_method](input_shape_for_comm, args)#调用modules/tar_comm.py
    ...
    def forward(self, ep_batch, t, test_mode=False, thres=0., prob=0.):#关键函数
    ...
    def _communicate(self, bs, inputs, hidden_states, test_mode, thres=0., prob=0.):
        ...
        if test_mode:
            ...
            #查询和其它智能体签名的相关性记作scores，并softmax
